        ...
        <section className="title">
          ...
          <div className="main-psc">
            ...
            <div className="main-brands-text">
              ...
              <div className="p-text">
                <p>
                  프랑스 파리는 파리지앵의 본고장입니다.
                  <br />
                  이곳에서 시작된 펫 소 시크는
                  <br />
                  우아함, 세련됨, 고상함을 대표하고 흠잡을 데 없는
                  <br />
                  스타일을 연출합니다.
                </p>
              </div>
          ...
          <div className="vid-free-items">
            <div className="main-layer-img-bx vid-layer1">
              <img
                src="./images/main/pattern-grass-01.jpg"
                alt="레이어 이미지1"
              />
            </div>
            <div className="main-layer-img-bx vid-layer2">
              <img
                src="./images/main/pattern-grass-02.jpg"
                alt="레이어 이미지1"
              />
            </div>
            <div className="main-layer-img-bx vid-layer3">
              <img
                src="./images/main/pattern-footprint.png"
                alt="레이어 이미지1"
              />
            </div>
            <div className="main-layer-img-bx vid-layer4">
              <img
                src="./images/main/pattern-grass-03.jpg"
                alt="레이어 이미지1"
              />
            </div>
            <div className="main-layer-img-bx vid-layer5">
              <img
                src="./images/main/pattern-grass-05.jpg"
                alt="레이어 이미지1"
              />
            </div>
          </div>
        ...
        <div id="mb-vid-bx">
          <div className="show-txt image-container">
            <div className="delayed-image image1">
              <img
                src="./images/main/layer-maxbone-text.jpg"
                alt="맥스본 텍스트 이미지"
              />
            </div>
        ...
        <section>
          ...
          <div className="milkpepper-inbox">
            <div className="mp-img-bx">
              <img
                src="./images/main/brand-milkpepper-cat.jpg"
                alt="밀크앤페퍼 이미지"
              />
            </div>
            <div className="mp-txt-bx">
              <img
                src="./images/main/logo-milkpepper.svg"
                alt="밀크앤페퍼 텍스트 이미지"
              />
              <p>
                일년 내내 우아할 수 있는 <br />
            ...
            <ul>
              <li>
                <a href="sub7_cotielog.html">
                  <img
                    src="./images/main/review-puppy.jpg"
                    alt="우수리뷰고객 캐리커쳐 이미지"
                  />
              ...
              <li>
                <a href="sub7_cotielog.html">
                  <img
                    src="./images/main/cotielog-02.jpg"
                    alt="오프라인입점매장안내 이미지"
                  />
                  <h4>오프라인 입점 매장 안내</h4>
                </a>
              ...
              <li>
                <a href="sub7_cotielog.html">
                  <img
                    src="./images/main/GDWEB.png"
                    alt="GDWEB 디자인 어워즈 수상 이미지"
                  />
