  ...
  <div id="sub-petsochic-visual-wrap">
        <div className="psc-visual">
            ...
            <div className="psc-img-wrap">
                <img src="../../public/images/sub1_petsochic/visual-petsoshic.jpg" alt="펫소시크 이미지" />
            </div>
        </div>
        {/* <!-- 펫소시크 레이어 이미지 박스 --> */}
        <div className="psc-free-items">
           <div className="layer-img-bx psc-layer1">
               <img src="../../public/images/sub1_petsochic/layer-tower.gif" alt="펫소시크 타워 레이어 이미지"/>
           </div>
           <div className="layer-img-bx psc-layer2">
               <img src="../../public/images/sub1_petsochic/layer-neck-petsochic.gif" alt="펫소시크 목줄 레이어 이미지"/>
           </div>
        </div>
    </div>
     ...
     <div id="brands-wrap">
            <div className="petsochic">
                <div className="move-dog">
                    <img src="../../public/images/main/brand-petsoshic.gif" alt="petsoshic-img" />
                </div>
                <div className="brands-text">
                    <div className="text-img">
                        <img src="../../public/images/main/logo-petsoshic.svg" alt="펫 소 시크 로고이미지" />
                    </div>
            ...
            <div id="founder-story-wrap">
                <article className="founder-inbox">
                    ...
                    <div className="hello-img-bx">
                        <img src="../../public/images/sub1_petsochic/intro-petsoshic-02.gif" alt="헬로강아지 이미지"/>
                    </div>
                </article>
            </div>
            ...
            <div id="psc-philosophy-wrap">
                <div className="philosophy-inbox psc-p1">
                    <div className="phil-img-bx">
                        <img src="../../public/images/sub1_petsochic/intro-petsoshic-03.jpg" alt=""/>
                    </div>
                ...
                <div className="philosophy-inbox psc-p2">
                    <div className="phil-img-bx phil-img1">
                        <img src="../../public/images/sub1_petsochic/intro-petsoshic-05.gif" alt=""/>
                    </div>
                    <div className="phil-img-bx phil-img2">
                        <img src="../../public/images/sub1_petsochic/intro-petsoshic-04.jpg" alt=""/>
                    </div>
                </div>
            </div>
            ...
            <div id="psc-brand-title">
                <div className="psc-title-inbox">
                    ...
                    <div className="psc-title-img-bx">
                        <img src="../../public/images/sub1_petsochic/note-petsoshic.jpg" alt="펫소시크 타이틀 이미지"/>   
                     </div>
                </div>
            </div>
                    ...
                    <ul className="new-lists-bx swiper-wrapper">
                        <li className="swiper-slide">
                            <a href="sub6_item_detail.html">
                                <div className="imbx">
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic1.jpg" alt="포레스트 그린 리드줄" />
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic1-1.jpg" alt="포레스트 그린 리드줄" />
                                </div>
                        ...
                        <li className="swiper-slide">
                            <a href="sub6_item_detail.html">
                                <div className="imbx">
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic2.jpg" alt="패딩자켓(레드)" />
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic2-1.jpg" alt="패딩자켓(레드)" />
                                </div>
                                <div className="swiper-txt-bx">
                                    <h3>PET SO CHIC</h3>
                        ...
                        <li className="swiper-slide">
                            <a href="sub6_item_detail.html">
                                <div className="imbx">
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic3.jpg" alt="미스테리 블랙 목줄" />
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic3-1.jpg" alt="미스테리 블랙 목줄" />
                                </div>
                                <div className="swiper-txt-bx">
                                    <h3>PET SO CHIC</h3>
                        ...
                        <li className="swiper-slide">
                            <a href="sub6_item_detail.html">
                                <div className="imbx">
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic4.jpg" alt="토프 리드줄" />
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic4-1.jpg" alt="토프 리드줄" />
                                </div>
                                <div className="swiper-txt-bx">
                                    <h3>PET SO CHIC</h3>
                        ...
                        <li className="swiper-slide">
                            <a href="sub6_item_detail.html">
                                <div className="imbx">
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic5.jpg" alt="고양이 반다나" />
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic5-1.jpg" alt="고양이 반다나" />
                                </div>
                                <div className="swiper-txt-bx">
                                    <h3>PET SO CHIC</h3>
                        ...
                        <li className="swiper-slide">
                            <a href="sub6_item_detail.html">
                                <div className="imbx">
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic6.jpg" alt="포레스트 그린 리드줄" />
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic6-1.jpg" alt="포레스트 그린 리드줄" />
                                </div>
                                <div className="swiper-txt-bx">
                                    <h3>PET SO CHIC</h3>
                                    <span>펫 소 시크 Dog leash Forest Green (포레스트 그린)</span>
                        ...
                        <li className="swiper-slide">
                            <a href="sub6_item_detail.html">
                                <div className="imbx">
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic7.jpg" alt="오렌지 텐저린 리드줄" />
                                    <img src="../../public/images/sub1_petsochic/goods/petsochic7-1.jpg" alt="오렌지 텐저린 리드줄" />
                                </div>
                                <div className="swiper-txt-bx">
                                    <h3>PET SO CHIC</h3>
